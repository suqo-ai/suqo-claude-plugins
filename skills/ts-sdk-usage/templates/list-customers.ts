 ...
 *
 * Customer.id is an opaque "cus_..."-prefixed string, not a number —
...
async function main(): Promise<void> {
  ...
  if (first) {
    // retrieve() takes the same opaque "cus_..." string id — fetch this one again to show the single-record shape.
